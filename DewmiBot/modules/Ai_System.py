...
from DewmiBot.pyrograme.pluginshelper import admins_only, edit_or_reply
from DewmiBot import pbot as hexzy
...
async def hmm(_, message):
    ...
    if status == "ON" or status == "on" or status == "On":
        ...
        if not lol:
            await lel.edit("Rose AI Already Activated In This Chat")
            return
        await lel.edit(
            f"Rose AI Successfully Added For Users In The Chat {message.chat.id}"
        )
        ...
        if not Escobar:
            await lel.edit("Rose AI Was Not Activated In This Chat")
            return
        await lel.edit(
            f"Rose AI Successfully Deactivated For Users In The Chat {message.chat.id}"
        )
...
__help__ = """
<b> Ai System </b>
Rose AI 3.0 IS THE ONLY AI SYSTEM WHICH CAN DETECT & REPLY UPTO 200 LANGUAGES
