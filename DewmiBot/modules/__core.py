...
from datetime import datetime
water = './GroupMenter/resources/photo_2021-09-14_17-36-29.jpg'
client = tbot
...
from DewmiBot.events import load_module
import asyncio
import os
from datetime import datetime
        ...
        try:
            downloaded_file_name = (
                await event.client.download_media(  # pylint:disable=E0602
                    ...
                    "DewmiBot/modules/",  # pylint:disable=E0602
                )
            )
...
from DewmiBot import telethn as tbot, OWNER_ID, DEV_USERS
from DewmiBot.events import register
import os
import asyncio
import os
